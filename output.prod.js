{
  mode: 'production',
  context: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task',
  devtool: 'source-map',
  output: {
    hashFunction: 'xxhash64',
    path: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\dist',
  ...
  resolve: {
    alias: {
      '@': 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\src',
    ...
    modules: [
      'node_modules',
      'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\node_modules',
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\node_modules\\@vue\\vue-loader-v15\\lib\\index.js',
            options: {
              compilerOptions: {
                whitespace: 'condense'
              }
        ...
        use: [
          ...
          /* config.module.rule('js').use('babel-loader') */
          {
            ...
            options: {
              ...
              cacheDirectory: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\node_modules\\.cache\\babel-loader',
              cacheIdentifier: 'fe24fb38'
            }
          }
        ]
      }
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        title: 'hubnero_test_task',
        scriptLoading: 'defer',
        templateParameters: function () { /* omitted long function */ },
        template: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\public\\index.html'
      }
    ),
    /* config.plugin('copy') */
    new CopyPlugin(
      {
        patterns: [
          {
            from: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\public',
            to: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\dist',
            toType: 'dir',
            noErrorOnMissing: true,
            globOptions: {
              ignore: [
                '**/.DS_Store',
                'D:/frontend_projects/test_tasks/hubnero_test_task/public/index.html'
              ]
            },
            info: {
              minimized: true
    ...
    new ESLintWebpackPlugin(
      {
        ...
        cwd: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task',
        cache: true,
        cacheLocation: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\node_modules\\.cache\\eslint\\49bf773e.json',
        context: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task',
        failOnWarning: false,
        failOnError: true,
        eslintPath: 'D:\\frontend_projects\\test_tasks\\hubnero_test_task\\node_modules\\eslint',
        formatter: 'stylish'
      }
    )
  ],
